...
use crate::error::{DCMIResult, dcmi_try, DCMIError, GetDataError};
use crate::structs::{AICPUInfo, AICoreInfo, BoardInfo, ChipInfo, ChipPCIEErrorRate, DieInfo, DomainPCIEInfo, ECCInfo, ELabelInfo, FlashInfo, HBMInfo, MemoryInfo, PCIEInfo};
#[cfg(feature = "serde")]
...
impl Card<'_> {
    ...
    pub fn get_chips(&self) -> DCMIResult<(Vec<Chip>, Option<Chip>, Option<Chip>)> {
        ...
        let npu_chips = (0..device_id_max).into_iter()
            .map(|id| Chip{card: &self, id: id as u32, unit_type: Some(UnitType::NPU)})
            .collect::<Vec<_>>();
        let mcu_chip = if mcu_id != -1 {
            Some(Chip{card: &self, id: mcu_id as u32, unit_type: Some(UnitType::MCU)})
        } else {
            None
        };
        let cpu_chip = if cpu_id != -1 {
            Some(Chip{card: &self, id: cpu_id as u32, unit_type: Some(UnitType::CPU)})
        } else {
            None
        };
...
impl Chip<'_, '_> {
    ...
    pub fn get_board_info(&self) -> DCMIResult<BoardInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_board_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut board_info);
    ...
    pub fn get_elabel_info(&self) -> DCMIResult<ELabelInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_elabel_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut elabel_info);
    ...
    pub fn get_power_info(&self) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_power_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut power_info);
    ...
    pub fn get_die_info(&self, target: DieType) -> DCMIResult<DieInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_die_v2, self.card.dcmi.lib, self.card.id as i32, self.id as i32, target.into(), &mut die_id);
    ...
    pub fn get_health(&self) -> DCMIResult<HealthState> {
        ...
        call_dcmi_function!(dcmi_get_device_health, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut health);
    ...
    pub fn get_error_code(&self) -> DCMIResult<Vec<u32>> {
        ...
        call_dcmi_function!(dcmi_get_device_errorcode_v2, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut error_count, error_code_list.as_mut_ptr(), 128);
    ...
    /// # Notes
    /// Only NPU and MCU chip support this function
    pub fn get_error_code_string(&self, error_code: u32, query_simplified_info: bool) -> DCMIResult<String> {
        let mut error_code_string = [0u8; 256];
        let len = if query_simplified_info {
            48
        } else {
            256
        };
        ...
        call_dcmi_function!(
            dcmi_get_device_errorcode_string, self.card.dcmi.lib, 
            self.card.id as i32,
            self.id as i32,
            error_code,
        ...
        Ok(CStr::from_bytes_until_nul(&error_code_string).unwrap().to_str()?.into())
    }
    ...
    pub fn get_flash_count(&self) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_flash_count, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut flash_count);
    ...
    pub fn get_flash_info(&self, flash_id: u32) -> DCMIResult<FlashInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_flash_info_v2, self.card.dcmi.lib, self.card.id as i32, self.id as i32, flash_id, &mut flash_info);
    ...
    pub fn get_ai_core_info(&self) -> DCMIResult<AICoreInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_aicore_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut ai_core_info);
    ...
    pub fn get_ai_cpu_info(&self) -> DCMIResult<AICPUInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_aicpu_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut ai_cpu_info);
    ...
    pub fn get_system_time(&self) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_system_time, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut system_time);
    ...
    pub fn get_temperature(&self) -> DCMIResult<i32> {
        ...
        call_dcmi_function!(dcmi_get_device_temperature, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut temperature);
        
        Ok(
            check_value!(temperature)?
        )
    }
    ...
    pub fn get_voltage(&self) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_voltage, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut voltage);
    ...
    pub fn get_pcie_error_cnt(&self) -> DCMIResult<ChipPCIEErrorRate> {
        ...
        call_dcmi_function!(dcmi_get_device_pcie_error_cnt, self.card.dcmi.lib, self.card.id as i32, self.id as i32, &mut pcie_error_rate);
    ...
    pub fn get_ecc_info(&self, target: DeviceType) -> DCMIResult<ECCInfo> {
        ...
        call_dcmi_function!(dcmi_get_device_ecc_info, self.card.dcmi.lib, self.card.id as i32, self.id as i32, target.into(), &mut ecc_info);
    ...
    pub fn get_frequency(&self, target: FrequencyType) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_frequency, self.card.dcmi.lib, self.card.id as i32, self.id as i32, target.into(), &mut frequency);
    ...
    pub fn get_utilization_rate(&self, target: UtilizationType) -> DCMIResult<u32> {
        ...
        call_dcmi_function!(dcmi_get_device_utilization_rate, self.card.dcmi.lib, self.card.id as i32, self.id as i32, target.into(), &mut utilization_rate);
